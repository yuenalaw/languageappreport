...
Based on my survey, Duolingo was the most used language learning app, followed by Anki and Memrise. Anki is a general flashcard platform and Memrise is a language app also famous for its gamification. Students mentioned that the most useful functionalities were being able to listen to pronunciations, the gamification aspects (the ability to compete against friends through leaderboards and the short lessons which gives a feeling of progression), as well as spaced repetition. These findings match with my research seen in the context survey, but what was emphasised in the survey was the importance of User Experience (UX) and the app's User Interface (UI).
...
Duolingo's course follows the school system, which gives a limited set of vocabulary. For example, you are more likely to learn 'I play football' if you are a footballer rather than a basketballer. The survey results display that students learn from online resources and content rather than textbooks, where they have unlimited access to niche topics that are personalised to them. Therefore, creating an app that utilises these personalised content can make their learning more enjoyable, improving their language learning consistency and also help them achieve fluency by widening their vocabulary scope to more specialised words unique to them.
