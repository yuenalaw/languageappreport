...
The disadvantage of shadowing is that a learner cannot hear themselves speak, as the attention is on listening to input and reproducing it orally. Thus, the paper emphasises the importance of learners recording themselves for self-reflection, re-iterating what we have seen in the context survey.
